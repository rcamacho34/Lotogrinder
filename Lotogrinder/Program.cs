    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("[9] - Processar Todos os Concursos ");
            ...
            while (opcao.Key != ConsoleKey.D1 && opcao.Key != ConsoleKey.D2 && 
                    ...
                    opcao.Key != ConsoleKey.D9 && opcao.Key != ConsoleKey.D0);
            ...
            else
            {
                ...
                else if (opcao.Key == ConsoleKey.D4)
                {
                    do
                    {
                        ...
                        Grinder.ProcessarAtraso(1, 3268760, false);
                ...
                else if (opcao.Key == ConsoleKey.D7)
                {
                    do
                    {
                        ...
                        Grinder.ProcessarUltimosAtrasos(1, 100000);
                ...
                else if (opcao.Key == ConsoleKey.D9)
                {
                    DateTime inicio = DateTime.Now;
